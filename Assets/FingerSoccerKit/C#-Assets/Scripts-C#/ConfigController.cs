...
public class ConfigController : MonoBehaviour {
	...
	public List<Texture2D> availableTeams = new List<Texture2D> ();
	...
	//public Texture2D[] availableTeams,newTeams1,newTeams2;	//just the images.
	...
	void fixCounterLengths (){
		...
		//Player-1 team
		if(p1TeamCounter > availableTeams.Count - 1)
			p1TeamCounter = 0;
		if(p1TeamCounter < 0)
			p1TeamCounter = availableTeams.Count - 1;
		...
		//Player-2 team
		if(p2TeamCounter > availableTeams.Count - 1)
			p2TeamCounter = 0;
		if(p2TeamCounter < 0)
			p2TeamCounter = availableTeams.Count - 1;
